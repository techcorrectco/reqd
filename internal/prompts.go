...
- Ensure the requirement includes exactly one RFC 2119 keyword (MUST, SHOULD, or MAY). Suggest the most appropriate keyword if missing or incorrect.
...

{
  ...
  "keyword": "<Explicit RFC 2119 keyword used: MUST, SHOULD, or MAY>"
}
